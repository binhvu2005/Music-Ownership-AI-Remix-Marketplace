import { Controller, Get, Put, Delete, Body, Param, Query, Req, UseGuards } from '@nestjs/common';
...
export class MusicController {
  ...
  async findAll(
    ...
    return this.musicService.findAll({ genre, ownerId, isPublished: publishedFilter });
  }
