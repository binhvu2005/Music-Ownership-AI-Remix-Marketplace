...
> Xem chi tiết tại `.superpowers/coding-rules.md`
...
- [SRS Gốc](../tailieugoc/srs.md)
- [Cấu trúc Dự án](../tailieugoc/cautrucduan.md)
- [Obsidian Guide](../tailieugoc/obsidian.md)
- [Superpowers Guide](../tailieugoc/supperpowers.md)
