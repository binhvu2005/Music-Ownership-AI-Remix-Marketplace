...
- [x] **Mô tả**: Tạo thư mục `code/` và khởi tạo mã nguồn dự án.
- [x] **Chi tiết**:
...
- [x] **Mô tả**: Dựng môi trường chạy thử cục bộ cho các dịch vụ phụ trợ.
- [x] **Chi tiết**:
...
- [x] **Mô tả**: Cấu hình các bảng dữ liệu cốt lõi của StemVerse trên database.
- [x] **Chi tiết**:
...
- [x] **Mô tả**: Viết API đăng ký, đăng nhập và xác thực token JWT.
- [x] **Chi tiết**:
...
- [x] **Mô tả**: Thiết lập khung giao diện Next.js cho người dùng.
- [x] **Chi tiết**:
